...
\setromanfont[Mapping=tex-text,BoldFont=STHeiti]{STFangsong}
\setmonofont{STHeiti}
...
% 从这里开始，第一页，封面PDF
\includegraphics[scale=0.8]{cover/cover.pdf}
...
% 这个应该是begin document后的第一个命令，因为它开始计页码，只不过，这里是罗马数字
% 它与mainmatter相关；mainmatter表示之后的页码，都是重新开始编号的阿拉伯数字
\frontmatter
\pagestyle{plain}
